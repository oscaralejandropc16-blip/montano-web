        ...
        <section id="productos" className="py-32 px-6 max-w-7xl mx-auto relative z-10">
          <div className="flex flex-col md:flex-row justify-between items-end mb-16 gap-6">
            <div>
              ...
              <p className="text-gray-400 max-w-md text-sm leading-relaxed">Descubre nuestra selección exclusiva de embutidos, elaborados con los más altos estándares de calidad y pasión artesanal.</p>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
              ...
              <div className="order-1 lg:order-2 relative">
                ...
                <div className="absolute -bottom-10 -left-10 w-40 h-40 rounded-full border border-white/10 bg-[#050505]/80 backdrop-blur-xl flex flex-col items-center justify-center p-6 text-center animate-spin-slow shadow-2xl">
                  ...
                  <span className="text-white text-[8px] tracking-[0.2em] uppercase">Años de Calidad</span>
                </div>
              </div>
              ...
              return (
                <div key={i} className="aspect-square bg-[#111] relative group overflow-hidden">
                  <div className="absolute inset-0 bg-black/40 opacity-0 group-hover:opacity-100 transition-opacity duration-300 z-10 flex items-center justify-center">
                    <span className="text-white text-xs font-bold tracking-widest uppercase border border-white px-4 py-2 opacity-0 group-hover:opacity-100 transform translate-y-4 group-hover:translate-y-0 transition-all duration-300">Ver Más</span>
                  </div>
                  {img ? (
