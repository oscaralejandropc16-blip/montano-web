...
export default function AboutPage() {
  ...
  return (
    <div className="min-h-screen bg-white text-foreground overflow-hidden">
      ...
      <main>
        ...
        <section className="relative h-[40vh] min-h-[400px] flex items-center justify-center text-center overflow-hidden bg-black">
          <div className="absolute inset-0 z-0">
             ...
             {/* Imagen de fondo genérica para la cabecera */}
             <div className="absolute inset-0 flex items-center justify-center text-white/10" style={{ backgroundImage: "url('/placeholder-hero.jpg')", backgroundSize: 'cover', backgroundPosition: 'center 30%' }}></div>
          </div>
      ...
      {/* FOOTER */}
      <footer className="bg-black text-white/50 py-8 px-6 text-center text-xs tracking-wider border-t border-white/10">
        <p>Copyright © 2026 Montano Antilia. Todos los derechos reservados.</p>
      </footer>
    </div>
  );
}
